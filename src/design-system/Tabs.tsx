    ...
    return (
      <TabsPrimitive.Trigger
        ...
        className={cn(
          ...
          'data-[state=active]:bg-accent-100 data-[state=active]:text-brand-800 data-[state=active]:shadow-sm',
          'data-[state=active]:ring-1 data-[state=active]:ring-inset data-[state=active]:ring-accent-600',
