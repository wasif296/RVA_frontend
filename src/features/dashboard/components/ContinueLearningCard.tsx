...
import { CourseThumbnail } from '../../courses/components/CourseThumbnail';
  ...
  return (
    <article className="card-highlight overflow-hidden rounded-xl border">
      <div className="flex flex-col sm:flex-row">
        <CourseThumbnail src={item.thumbnailUrl} className="sm:w-56 sm:shrink-0" />
        <div className="flex min-w-0 flex-1 flex-col gap-4 p-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
